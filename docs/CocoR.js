    ...
    */
    ...
    var ParserGen = /** @class */ (function () {
        ...
        ParserGen.prototype.GenSymbolTables = function (declare) {
            for (var _i = 0, _a = this.tab.symtabs; _i < _a.length; _i++) {
                ...
                if (declare) {
                    if (this.langGen == "js")
                        this.gen.WriteLine("\tParser.prototype." + st.name + "_ST = null;");
                    else
                        this.gen.WriteLine("\tpublic readonly " + st.name + "_ST : Symboltable | null;");
                }
                else {
    ...
    var DFA = /** @class */ (function () {
        ...
        DFA.prototype.WriteScanner = function () {
            ...
            if (this.ignoreCase) {
                if (this.langGen == "js")
                    this.gen.Write("\tlet valCh;       // current input character (for token.val)");
                else
