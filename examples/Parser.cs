...
public class Parser {
	...
	public const int _NT_SymboltableDecl = 5;
	public const int _NT_AttrDecl = 6;
	public const int _NT_SemText = 7;
	public const int _NT_Expression = 8;
	public const int _NT_SimSet = 9;
	public const int _NT_Char = 10;
	public const int _NT_Sym = 11;
	public const int _NT_Term = 12;
	public const int _NT_Resolver = 13;
	public const int _NT_Factor = 14;
	public const int _NT_Attribs = 15;
	public const int _NT_Condition = 16;
	public const int _NT_TokenTerm = 17;
	public const int _NT_TokenFactor = 18;
	public const int maxNT = 18;
	//terminals
...
//	public const int _("SYMBOLTABLES") = 17;
//	public const int _("PRODUCTIONS") = 18;
//	public const int _("=") = 19;
//	public const int _(".") = 20;
//	public const int _("END") = 21;
//	public const int _("STRICT") = 22;
//	public const int _("+") = 23;
//	public const int _("-") = 24;
//	public const int _("..") = 25;
//	public const int _("ANY") = 26;
...
//	public const int _("WEAK") = 34;
//	public const int _("(") = 35;
//	public const int _(")") = 36;
//	public const int _("[") = 37;
//	public const int _("]") = 38;
//	public const int _("{") = 39;
//	public const int _("}") = 40;
//	public const int _("SYNC") = 41;
//	public const int _("IF") = 42;
//	public const int _("CONTEXT") = 43;
//	public const int _("(.") = 44;
//	public const int _(".)") = 45;
//	public const int _(???) = 46;
...
/*-------------------------------------------------------------------------*/
	...
	void SkipNested(int leftKind, int rightKind) {
		// manage nested braces
		if(la.kind != rightKind) {
			for (int nested = 1; nested > 0;) {
				//print("==", la.line, nested, la.kind, la.val);
				if(la.kind == leftKind) ++nested;
				Get();
				if(la.kind == rightKind) --nested;
				else if(la.kind == _EOF) break;
			}
		}
	}

	void SkipTill(int endKind) {
		while(la.kind != endKind || la.kind != _EOF) {
			Get();
		}
	}

	void SkipTillEOL() {
		int currLine = la.line;
		while(la.line == currLine || la.kind != _EOF) {
			Get();
		}
	}
	...
	void Coco_NT() {
		...
		while (!(isKind(la, _EOF) || isKind(la, 18 /* "PRODUCTIONS" */))) {SynErr(47); Get();}
	...
	void TokenDecl_NT(int typ) {
		...
		while (!(StartOf(5 /* sync  */))) {SynErr(48); Get();}
		if (isKind(la, 19 /* "=" */) || isKind(la, 28 /* "@" */)) {
			if (isKind(la, 28 /* "@" */)) {
				Get();
				sym.eqAttribute = t.val[0]; 
			}
			Expect(19 /* "=" */);
			TokenExpr_NT(out g);
			Expect(20 /* "." */);
	...
	void Set_NT(out CharSet s) {
		CharSet s2; 
		SimSet_NT(out s);
		while (isKind(la, 23 /* "+" */) || isKind(la, 24 /* "-" */)) {
			if (isKind(la, 23 /* "+" */)) {
				Get();
				SimSet_NT(out s2);
				s.Or(s2); 
	...
	static readonly bool[,] set = {
		{_T,_T,_x,_T, _x,_T,_x,_x, _x,_x,_x,_T, _T,_x,_x,_x, _T,_T,_T,_T, _x,_x,_x,_x, _x,_x,_x,_x, _T,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _T,_x,_x,_x},
		...
		{_x,_T,_T,_T, _T,_T,_T,_x, _x,_x,_x,_x, _x,_T,_T,_T, _x,_x,_x,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_x},
		{_T,_T,_x,_T, _x,_T,_x,_x, _x,_x,_x,_T, _T,_x,_x,_x, _T,_T,_T,_T, _T,_x,_x,_x, _x,_x,_T,_x, _T,_x,_x,_x, _x,_T,_T,_T, _x,_T,_x,_T, _x,_T,_T,_x, _T,_x,_x,_x},
		{_T,_T,_x,_T, _x,_T,_x,_x, _x,_x,_x,_T, _T,_x,_x,_x, _T,_T,_T,_T, _x,_T,_x,_x, _x,_x,_x,_x, _T,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _T,_x,_x,_x},
		{_T,_T,_x,_T, _x,_T,_x,_x, _x,_x,_x,_T, _T,_x,_x,_x, _T,_T,_T,_T, _x,_x,_x,_x, _x,_x,_x,_x, _T,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _T,_x,_x,_x},
		{_x,_T,_x,_T, _x,_T,_x,_x, _x,_x,_x,_T, _T,_x,_x,_x, _T,_T,_T,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _T,_x,_x,_x},
		{_x,_T,_x,_T, _x,_T,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_T, _x,_T,_x,_T, _x,_x,_x,_x, _x,_x,_x,_x},
		{_x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _T,_x,_T,_T, _T,_T,_T,_x, _T,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _T,_x,_T,_x, _T,_x,_x,_x, _x,_x,_x,_x},
		{_x,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_x,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_x},
		{_x,_T,_T,_T, _x,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_x,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_x},
		...
		{_x,_T,_x,_T, _x,_T,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _T,_x,_x,_x, _x,_x,_T,_x, _x,_x,_x,_x, _x,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_x, _T,_x,_x,_x},
		{_x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _T,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _T,_x,_T,_x, _T,_x,_x,_x, _x,_x,_x,_x},
		{_x,_T,_x,_T, _x,_T,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_T,_x, _x,_x,_x,_x, _x,_x,_T,_T, _x,_T,_x,_T, _x,_T,_T,_x, _T,_x,_x,_x},
		{_x,_T,_x,_T, _x,_T,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_T,_x, _x,_x,_x,_x, _x,_x,_T,_T, _x,_T,_x,_T, _x,_T,_x,_x, _T,_x,_x,_x},
		{_x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _T,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_T,_x,_x, _T,_x,_T,_x, _T,_x,_x,_x, _x,_x,_x,_x},
		{_x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_T, _x,_T,_T,_T, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x},
		{_x,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_T, _x,_T,_T,_T, _T,_T,_T,_T, _T,_T,_T,_x}
...
public class Symboltable {
	...
	public bool Add(Token t) {
		if(!predefined.Contains(t.val)) {
			predefined.Add(t.val);
			return true;
		}
		return false;
	}
	...
	public bool Use(Token t) {
		return predefined.Contains(t.val);
	}
}
}